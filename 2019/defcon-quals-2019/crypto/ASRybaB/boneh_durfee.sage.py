...
_sage_const_3 = Integer(3); _sage_const_2 = Integer(2); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_7 = Integer(7); _sage_const_60 = Integer(60); _sage_const_4 = Integer(4); _sage_const_p291 = RealNumber('.291'); _sage_const_0p292 = RealNumber('0.292')
import time
...
def example(N,e,m,name):
    ...
    delta = _sage_const_p291  # this means that d < N^delta
    #delta = 0.18
    #
...
if __name__ == "__main__":
    ...
    m= int(sys.argv[_sage_const_3 ])
    name = sys.argv[_sage_const_4 ]
    example(n,e,m,name)
